...
class AppContainer extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      progressMessage: '',
      userDownloadsFolder: localStorage.getItem('userSelectedFolder') ? localStorage.getItem('userSelectedFolder') : remote.app.getPath('desktop'),
    };
  ...
  getVideoAsMp4(urlLink, userProvidedPath, title) {
    ...
    return new Promise((resolve, reject) => {
      ...
      let videoObject = ytdl(urlLink, { filter: function(format) { return format.container === 'mp4'; } });
